...
SELECT 
	 State,count(restaurant_id) as Total_restaurant
FROM 	 restaurants
GROUP BY State
...
SELECT 
	 city,count(restaurant_id) as Total_restaurant
FROM 	 restaurants
GROUP BY city
Order BY Total_restaurant DESC
...
SELECT 
	 alcohol_service,count(restaurant_id) as Total_restaurant
FROM 	 restaurants
...
SELECT 
	 smoking_allowed,count(restaurant_id) as Total_restaurant
FROM 	 restaurants
...
SELECT 
	 alcohol_service,smoking_allowed,count(restaurant_id) as Total_restaurant
FROM 	 restaurants
...
SELECT 
	 price,count(restaurant_id) as Total_restaurant
FROM 	 restaurants
GROUP BY price
Order BY Total_restaurant DESC
...
SELECT 
	 parking,count(restaurant_id) as Total_restaurant
FROM 	 restaurants
GROUP BY parking
Order BY Total_restaurant DESC
...
SELECT 
        cuisine,count(restaurant_id) AS Total_restaurant
...
SELECT 
	   name,count(cuisine) AS Total_cuisines,
